...
describe('GameListLoader', () => {
    ...
    it('should renders Loading when games is undefined and mode is "search"', () => {
        render(<GameListLoader {...defaultProps} games={undefined} mode="search" />);
        expect(screen.getByTestId('loading')).toBeInTheDocument();
    });

    it('should renders Message when games is undefined and mode is not "search"', () => {
    ...
    it('should renders Message when games is an empty array', () => {

...
import { registerRequest } from '../../request/auth';
...
export default function RegistrationForm() {
    ...
    const RegistrationSchema = Yup.object().shape({
        email: Yup.string().email(<Message string={'app.login.form.error.wrong.email'} />).required(<Message string={'app.login.form.error.empty.email'} />),
